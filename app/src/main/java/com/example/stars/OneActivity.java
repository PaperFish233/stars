...
public class OneActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.query("contents", new String[]{"_id","stop","simg","sword","send","stime","sstar","sheart"}, null, null, null, null, "_id desc");//"_id desc"表示根据id倒叙查表
        ...
        Toast.makeText(OneActivity.this, "已刷新，共有"+ num + "条内容！", Toast.LENGTH_SHORT).show();
        ...
        r1.setOnClickListener(new RelativeLayout.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(OneActivity.this, OneActivity.class);
        ...
        r3.setOnClickListener(new RelativeLayout.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(OneActivity.this, ThreeActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ivt1.setOnClickListener(new RelativeLayout.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(OneActivity.this, AddContentsActivity.class);
                startActivity(intent);
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null){
                convertView= LayoutInflater.from(OneActivity.this).inflate(R.layout.list_item,null);
            ...
            mHolder.Sheart.setOnClickListener(new RelativeLayout.OnClickListener(){
                ...
                public void onClick(View v) {
                    ...
                    if(Heart1.equals("1")){
                        ...
                        Toast.makeText(OneActivity.this, "取消收藏!", Toast.LENGTH_SHORT).show();
                    }else{
                        ContentValues value=new ContentValues();
                        value.put("sheart","1");
                        db.update("contents", value, "_id=?", new String[]{Sid1});
                        Toast.makeText(OneActivity.this, "成功收藏!", Toast.LENGTH_SHORT).show();
                    }
                    startActivity(intent);
                    finish();
                }
            ...
            Glide.with(OneActivity.this).load(url).into(mHolder.card_image);
